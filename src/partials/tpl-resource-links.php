<div class="wide-container">
      <div class="resources edge edge--top--reverse">
        <div class="container">
          <div class="row">
            <div class="col-md-4  reveal-resource">
              <div class="resources__resource">
                <div class="resources__resource-circle resources__resource-circle--yellow">
                  <i class="fas fa-sun fa-2x center-circle"></i>
                </div>
            ...
            <div class="col-md-4">
              <div class="resources__resource  reveal-resource-2">
            ...
            <div class="col-md-4">
              <div class="resources__resource  reveal-resource-3">
                <div class="resources__resource-circle resources__resource-circle--teal">
                  <i class="fas fa-hospital fa-2x center-circle"></i>
                </div>
