  ...
  <div class="story-callouts">
    ...
    <div class="row no-gutters">
      <?php foreach($articles as $article):?>
        <a href="<?php echo $GLOBALS['SITE_PATH']; ?>/article/<?php echo $article->intItemID; ?>" class="col-md-3 story-callouts__callout">
      ...
      <?php endforeach; ?>
      <a href="<?php echo $GLOBALS['SITE_PATH']; ?>/articles/" class="cta cta__primary">View All Stories</a>
    </div>
  </div>
</div>
